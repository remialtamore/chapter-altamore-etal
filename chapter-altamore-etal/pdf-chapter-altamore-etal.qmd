  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \author[1]{Rémi Altamore}
        \author[2]{Clément Roume}
        \author[1]{Anne Teboul}
        \author[1]{Christophe Gernigon}
        \affil[1]{EuroMov Digital Health in Motion, Université de Montpellier, IMT Mines Alès, Montpellier, France}
        \affil[2]{Institut de Recherche en Informatique, Mathématiques, Automatique et Signal (UR UHA 7499), Université de Haute-Alsace, Mulhouse, France}
...
```{r,message = FALSE, error = FALSE, warning = FALSE}
MotivationData <- import(
  "https://github.com/remialtamore/data_chapter/raw/main/Motivation.xlsx")
MotivationData
```
