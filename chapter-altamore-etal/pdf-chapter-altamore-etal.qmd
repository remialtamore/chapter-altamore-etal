      ...
      text: |
        ...
        \renewcommand{\maketitle}{
          \begin{center}
            ...
            \vspace{1em} 
            \textbf{Rémi Altamore\textsuperscript{1}, Clément Roume\textsuperscript{2}, Anne Teboul\textsuperscript{1}, and Christophe Gernigon\textsuperscript{1}} \par
            \vspace{1em} 
            \textsuperscript{1}EuroMov Digital Health in Motion, Université de Montpellier, IMT Mines Alès, Montpellier, France \\
            \textsuperscript{2}Institut de Recherche en Informatique, Mathématiques, Automatique et Signal (UR UHA 7499), Université de Haute-Alsace, Mulhouse, France
          \end{center}
          \vspace{2em}
        }
        \makeatother
...
MotivationData <- import(
  "https://github.com/remialtamore/chapter-altamore-etal/raw/main/chapter-altamore-etal/Motivation.xlsx")
