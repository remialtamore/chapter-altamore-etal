...
First, we load the data with `import()` function from `rio` and visualize an extract of them with the function `gt_preview()`.

```{r,message = FALSE, error = FALSE, warning = FALSE}
MotivationData <- import ("https://github.com/remialtamore/chapter-altamore-etal/raw/main/chapter-altamore-etal/Motivation.xlsx")
